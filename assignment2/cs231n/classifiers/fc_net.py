...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None):
    ...
    ar1_out, ar1_cache = affine_relu_forward(
        X, self.params['W1'], self.params['b1'])
    a2_out, a2_cache = affine_forward(
        ar1_out, self.params['W2'], self.params['b2'])
    scores = a2_out
    #pass
    ############################################################################
    #                             END OF YOUR CODE                             #
    ...
    loss = loss + 0.5 * self.reg * \
        ...
        self.reg * np.sum(self.params['W2'] * self.params['W2'])
